...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(array('billing'=>'sales_flat_order_address'), 'main_table.entity_id = billing.parent_id AND billing.address_type="billing"',array('billing.postcode AS postcode'));
